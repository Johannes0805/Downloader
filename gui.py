...
class StartView(QtWidgets.QWidget):
    ...
    def __init__(self):
        super().__init__()
        uic.loadUi(resource_path("ui/start_widget.ui"), self)
...
class ProgressView(QtWidgets.QWidget):
    def __init__(self):
        super().__init__()
        uic.loadUi(resource_path("ui/progress_widget.ui"), self)

class EditView(QtWidgets.QWidget):
    def __init__(self):
        super().__init__()
        self.apply_push = None
        uic.loadUi(resource_path("ui/editmeta_widget.ui"), self)

class BulkEditView(QtWidgets.QWidget):
    def __init__(self):
        super().__init__()
        uic.loadUi(resource_path("ui/bulk_edit_widget.ui"), self)
...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        try:
            with open(resource_path("assets/music_genres.json"), "r") as genre_file:
